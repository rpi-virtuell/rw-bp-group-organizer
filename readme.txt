=== BP Group Organizer ===
Contributors: ddean, garrett-eclipse, johappel
...
== Changelog ==
= 1.0.9 =
 * Fixed the Walker_Group_Edit class declariations for issue by garret eclipse
 * Fixed creating a new object if it doesn't already exist by garret eclipse
 * Fixed Compatibility to buddypress 2.7 by johappel
